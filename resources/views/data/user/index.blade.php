                ...
                <div class="row"><div class="col-sm-12 table-responsive"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            @forelse($users as $user)
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td class="">
                                        <a href="/data/user/{{$user->id}}/show" style="display:inline-block;"><button class="btn btn-sm btn-primary"><span class="fa fa-eye"></span> Show</button></a>
                                        <a href="/data/user/{{$user->id}}/edit" style="display:inline-block;"><button class="btn btn-sm btn-warning"><span class="fa fa-edit"></span> Edit</button></a>
                                        <form action="/data/user/{{$user->id}}/delete" method="post" style="display:inline-block;">
                                            {{csrf_field()}}
