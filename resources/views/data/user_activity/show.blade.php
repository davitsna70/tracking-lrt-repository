        ...
        <div class="box-body">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">User Activity {{$user_activity->id}}</h3>
                </div>
                <!-- /.box-header -->
                <div class="row">
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>ID</td>
                                <td>{{$user_activity->id}}</td>
                            </tr>
                            <tr>
                                <td>User</td>
                                <td>{{$user_activity->user->group->nama_group}} - {{$user_activity->user->name}}</td>
                            </tr>
                            <tr>
                                <td>Activity</td>
                                <td>{{$user_activity->activity->judul}}</td>
                            </tr>
                            <tr>
                                <td>Action</td>
                                <td>
