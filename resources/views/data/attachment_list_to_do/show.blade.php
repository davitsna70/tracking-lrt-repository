        ...
        <div class="box-body">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Attachment List To Do {{$attachment_list_to_do->id}}</h3>
                </div>
                <!-- /.box-header -->
                <div class="row">
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>ID</td>
                                <td>{{$attachment_list_to_do->id}}</td>
                            </tr>
                            <tr>
                                <td>Comment</td>
                                <td>{{$attachment_list_to_do->->list_to_do->activity->judul}}</td>
                            </tr>
                            <tr>
                                <td>Lampiran</td>
                                <td>{{$attachment_list_to_do->lampiran}}</td>
                            </tr>
                            <tr>
                                <td>Action</td>
                                <td>
