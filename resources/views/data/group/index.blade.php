...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Table Groups</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="/data/group/create">
                            <button class="btn btn-primary btn-sm"><span class="fa fa-plus-square"></span> &nbsp; Add New Group </button>
                        </a>
                    </div>
                </div>
                <div class="row"><div class="col-sm-12 table-responsive"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            @forelse($groups as $group)
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td class="">{{ $group['nama_group']}}</td>
                                    <td class="">{{ $group['alamat_kantor'] }}</td>
                                    <td class="">{{ $group['nomor_telepon'] }}</td>
                                    <td class="">{{ $group['fax'] }}</td>
                                    <td class="">{{ $group['email'] }}</td>
                                    <td class="">
                                        <a href="/data/group/{{$group->id}}/show" style="display:inline-block;"><button class="btn btn-sm btn-primary"><span class="fa fa-eye"></span> Show</button></a>
                        ...
                        </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Showing {{$groups->currentPage()}} to {{$groups->lastPage()}} of {{\App\Group::all()->count()}} entries</div></div><div class="col-sm-7">
