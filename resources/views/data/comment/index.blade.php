        ...
        <div class="box-body">
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="/data/comment/create">
                            <button class="btn btn-primary btn-sm"><span class="fa fa-plus-square"></span> &nbsp; Add New Comment </button>
                        </a>
                    </div>
                </div>
                <div class="row"><div class="col-sm-12 table-responsive"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            @forelse($comments as $comment)
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td class="">{{ $comment['user_id']}}</td>
                                    <td class="">{{ $comment['activity_id'] }}</td>
                                    <td class="">{{ $comment['isi'] }}</td>
                                    <td class="">
                                        <a href="/data/comment/{{$comment->id}}/show" style="display:inline-block;"><button class="btn btn-sm btn-primary"><span class="fa fa-eye"></span> Show</button></a>
                        ...
                        </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Showing {{$comments->currentPage()}} to {{$comments->lastPage()}} of {{\App\Comment::all()->count()}} entries</div></div><div class="col-sm-7">
