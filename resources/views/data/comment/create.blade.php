...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">Create New Comment</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <form role="form" action="{{url("/data/comment/save/")}}" method="post">
                {{csrf_field()}}
                ...
                <button class="btn btn-primary" name="create" value="create">Create Comment</button>
            </form>
        </div>
        <!-- /.box-body -->
    </div>
