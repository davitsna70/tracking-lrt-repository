        ...
        <div class="box-body">
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="{{url('/member_group/create')}}">
                ...
                <div class="row"><div class="col-sm-12 table-responsive"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            @forelse($users as $user)
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td class="">
                                        <a href="{{url('/member_group/'.$user->id.'/show')}}" style="display:inline-block;"><button class="btn btn-sm btn-primary"><span class="fa fa-eye"></span> Show</button></a>
                                        <a href="{{url('/member_group/'.$user->id.'/edit')}}" style="display:inline-block;"><button class="btn btn-sm btn-warning"><span class="fa fa-edit"></span> Edit</button></a>
